...
3. **Results**: Results are appended to the Tracks List. View and navigate a result in the Lineage View and Tracking segmentation and/or points layers
4. **Edit Results**: Use the Editing & Selection panel to refine results
5. **Visualize options**: Use the Visualization panel to adjust display and show orthogonal views.
6. **Save & Load**: Save or export results in the Tracks List. To pick up where you left off, load the project from Motile Run.

### Tips

- Right-click on the 'eye' icon (middle) at the top of the docked widgets to configure which menus are visible.
